...
local function_keys = function()
    ...
    hl.bind("XF86MonBrightnessUp",   hl.dsp.exec_cmd("brightnessctl --min-value=100 --exponent s 10%+"))
    hl.bind("XF86MonBrightnessDown", hl.dsp.exec_cmd("brightnessctl --min-value=100 --exponent s 10%-"))
end
