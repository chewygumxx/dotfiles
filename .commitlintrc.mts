...
const scopes: { delimiters: string[]; enum: Enumerable[] } = {
    ...
    enum: [
        ...
        { name: "herdr",    fullName: "Herdr",           description: "Terminal Multiplexer" },
        { name: "hypr",     fullName: "Hyprland",        description: "Wayland Compositor" },
        { name: "nushell",  fullName: "Nushell",         description: "Data-aware shell" },
        { name: "nvim",     fullName: "Neovim",          description: "Text Editor" },
        { name: "ssh",      fullName: "OpenSSH",         description: "Cryptographic Network Protocol" },
        { name: "systemd",  fullName: "Systemd",         description: "Service Manager" },
        { name: "termux",   fullName: "Termux",          description: "Terminal Emulator for Android" },
        { name: "waybar",   fullName: "Waybar",          description: "Wayland Status Bar" },
        { name: "wezterm",  fullName: "WezTerm",         description: "Terminal Emulator" },
        { name: "yay",      fullName: "Yay",             description: "AUR Helper and Pacman Wrapper" },
...
function promptQuestionEnum(enumerable: Enumerable[]) {
    return Object.fromEntries(enumerable.map((item) => [
        item.name, {
            title:       item.fullName,
...
const Configuration: UserConfig = {
    ...
    rules: {
        ...
        "scope-enum":            [ lvl.err, "always", scopes.enum.map((scope) => scope.name) ],
    ...
    prompt: {
        ...
        questions: {
            ...
            breakingBody:    { description: "Breaking change commits require a body", },
            breaking:        { description: "Breaking Changes Description", },
            isIssueAffected: { description: "Relevant Issues?", },
            issuesBody:      { description: "If issues are closed, the commit requires a body", },
            issues:          { description: "Issue References (eg. \"fix #123\", \"re #456\")", },
        },
    },
};
